...
public class CountryDetails extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE = "edu.monash.fit2081.countryinfo.MESSAGE";
    @Override
    ...
    public void wikiMe(View view) {
        Intent intent = new Intent(this, WikiWebViewActivity.class);
        TextView textView_countryName = (TextView)findViewById(R.id.country_name);
        String countryName = textView_countryName.getText().toString();
        intent.putExtra(EXTRA_MESSAGE, countryName);
